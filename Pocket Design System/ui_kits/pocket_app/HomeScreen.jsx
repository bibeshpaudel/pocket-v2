...
const { Icon, Kbd, ToolCard, EmptyState } = window.PocketDesignSystem_654e67;
...
function SearchTrigger({ onClick, wide }) {
...
function HomeScreen({ tools, categories, favorites, recents, onOpen, onStar, onOpenPalette }) {
...
Object.assign(window, { HomeScreen, SearchTrigger });
